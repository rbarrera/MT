	    ...
	    function addMenu() 
            {
                ...
                foreach( $post_types as $post_type_name ){
                    if (!is_post_type_hierarchical($post_type_name)){
                         add_submenu_page('edit.php?post_type='.$post_type_name, 'Ordenar', 'Ordenar', userdata_get_user_level(), 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                    }
                }
	        }
	    ...
	    function SortPage() 
            {
		        ...
		        <div class="wrap">
                    ...
                    <h2><?php echo $this->current_post_type->labels->singular_name . ' -  Ordenar '?></h2>
			        ...
			        <p class="submit">
				        <a href="#" id="save-order" class="button-primary">Actualizar</a>
			        </p>
